...
- Do not append application-branch changes to the upstream changelog. Release maintainers update it for released baseline behavior, compatibility, and release-flow changes.
