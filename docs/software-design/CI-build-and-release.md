...
4. **发布**：
   - **tag 触发** → 用 `softprops/action-gh-release@v2` 创建 GitHub Release，附带产物（`FoloToy-AI-Passport-full.bin`、`FoloToy-AI-Passport.bin`、`bootloader.bin`、`partition-table.bin`）。
